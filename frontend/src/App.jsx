...
function App() {  
  ...
  // Establish handler functions to be used throughout application components
        ...
        <Routes>
          ...
          <Route
            ...
            element={<Cart 
              ...
              handleDeleteFromShoppingCart={handleDeleteFromShoppingCart} 
              handleDeleteAllFromShoppingCart={handleDeleteAllFromShoppingCart} 
          ...
          <Route
            ...
            element={<Checkout 
              ...
              setOnConfirmationScreen={setOnConfirmationScreen}/>}
          />
          <Route
